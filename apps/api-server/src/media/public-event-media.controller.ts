...
export class PublicEventMediaController {
  ...
  private async handleRequest(
    ...
    const { key, mimeType } =
      await this.publicMediaService.resolvePublicEventMedia(slug, mediaId);
  ...
  async getMedia(
    ...
    return this.handleRequest(slug, mediaId, rangeHeader, res, false);
  }

  @Head(':slug/media/:mediaId')
  async headMedia(
    @Param('slug') slug: string,
    @Param('mediaId') mediaId: string,
    @Headers('range') rangeHeader: string,
    ...
    return this.handleRequest(slug, mediaId, rangeHeader, res, true);
  }
}
